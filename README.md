# `TravelCove API Documentation`

## Deployed URL
https://travelsite-xb4c.onrender.com/

## Database Schema Design
![Database Schema](https://dbdocs.io/bayscarissa706/TravelCove)
...
* Request
  ...
  * Query Parameters
    ...
    * size: integer, minimum: 1, default: 20
    * minLat: decimal, optional, must be between -90 and 90
    * maxLat: decimal, optional, must be between -90 and 90
    * minLng: decimal, optional, must be between -180 and 180
    * maxLng: decimal, optional, must be between -180 and 180
    * minPrice: decimal, optional, minimum: 0
    * maxPrice: decimal, optional, minimum: 0
    * city: string, optional, case-insensitive partial match
    * state: string, optional, case-insensitive partial match
    * country: string, optional, case-insensitive partial match
  ...
  * Body:
    ...
    ```json
    {
      ...
      "errors": {
        ...
        "price": "Minimum price cannot be greater than maximum price"
      }
    }
    ```
